...
SeqWire is not an application framework. It does not own your worker lifecycle, domain command protocol, UI model, or deployment policy. It gives those layers a typed runtime state contract and a handoff artifact they can move, validate, and bind.
